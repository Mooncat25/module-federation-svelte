...
function add_css(target) {
  append_styles(target, "svelte-jo1n1r", ".card.svelte-jo1n1r{background:#1f2124;box-shadow:0 0 20px rgba(0, 0, 0, 0.4);border-radius:5px;margin:20px 20px 20px 20px;width:250px;padding:20px;text-align:center;color:white;float:left}.title.svelte-jo1n1r{margin-top:10px;font-size:25px}svg.svelte-jo1n1r{width:100px;height:100px}path.svelte-jo1n1r{fill:#f6b352}");
}
